...
import { Lock, Home, ArrowLeft, Sparkles } from 'lucide-react';
    ...
    <div className="min-h-[80svh] flex flex-col items-center justify-center p-8 text-center select-none relative overflow-hidden">
      ...
      >
        ...
        <div className="space-y-2 mb-10">
            ...
            <h2 className="text-lg font-bold text-zinc-100 uppercase tracking-widest">Access Denied</h2>
            <p className="text-[10px] font-bold text-amber-500 uppercase tracking-widest">Protocol Error: Unauthorized Clearance</p>
      ...
      <div className="absolute bottom-10 left-1/2 -translate-x-1/2 flex items-center gap-2 opacity-20">
         ...
         <span className="text-[7px] font-bold uppercase tracking-widest text-zinc-100">Security Breach Blocked</span>
      </div>
    </div>
  );
};
