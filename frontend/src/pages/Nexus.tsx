        ...
        <div className="flex p-1 bg-white/5 rounded-xl border border-white/5 mx-auto mb-2 overflow-x-auto no-scrollbar scroll-fade-mask snap-x">
          {tabs.map(tab => (
            <button
              ...
              className={`flex-1 flex items-center justify-center space-x-2 py-2 px-4 rounded-lg text-[10px] font-black uppercase tracking-widest transition-all whitespace-nowrap active:scale-95 snap-center ${
