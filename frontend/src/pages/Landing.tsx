...
import { Database, Egg, Heart, PawPrint, ShieldCheck, Sparkles, Trophy, Zap } from 'lucide-react';
import { type CSSProperties, type ElementType, type PointerEvent, useMemo, useState } from 'react';
  ...
  return (
    <div className={`absolute z-10 ${className}`} style={wrapperStyle} aria-hidden="true">
      <motion.div
        ...
        {...(reduceMotion
          ? {}
          : { animate: { y: [0, -8, 0], rotate: [rotate, rotate + 1, rotate] } })}
      ...
      >
        ...
        <div className="space-y-3">
          ...
          <div className="space-y-1">
            <p className="text-[9px] font-bold leading-none text-white uppercase truncate">
              {title}
            </p>
    ...
    <div className="h-svh min-h-svh overflow-x-hidden overflow-y-auto bg-zinc-950 text-white select-none">
        ...
        <div className="relative z-30 mx-auto flex max-w-7xl flex-col justify-center h-full min-h-[60svh]">
          <div className="w-full max-w-2xl space-y-8">
            ...
            <p className="max-w-md text-xs font-medium leading-relaxed text-zinc-500 uppercase tracking-widest sm:text-sm">
              The definitive Telegram character management system. Secure units, expand your
              archive, and compete for network dominance.
            </p>
            ...
            {error && (
              <div className="mt-8 p-4 rounded-md border border-red-500/20 bg-red-500/5 flex flex-col sm:flex-row items-center justify-between gap-4">
                <p className="text-[10px] font-bold uppercase tracking-widest text-red-500/80">
                  {error}
                </p>
                {onRetry && (
                  <Button
      ...
      <main id="features" className="space-y-32 py-32">
            ...
            <div className="space-y-6">
              <div className="space-y-4">
                ...
                <p className="text-xs font-medium leading-relaxed text-zinc-500 uppercase tracking-widest max-w-sm">
                  Engineered for elite collectors. Every interaction is optimized for high-frequency
                  unit summoning within the Telegram ecosystem.
                </p>
              </div>
          ...
          <div className="mx-auto max-w-7xl text-center space-y-16">
            <div className="space-y-4">
              ...
              <p className="text-xs font-medium text-zinc-500 uppercase tracking-widest">
                Master the probability fields and secure high-value characters.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
              {[
                ...
                <Card key={i} variant="default" className="p-8 space-y-6">
                  <Badge variant={tier.variant as any} className="px-3 py-1 font-bold">
                    {tier.label}
                  </Badge>
        ...
        <section className="px-8 sm:px-12">
          <Card
            variant="surface"
            className="mx-auto max-w-5xl p-12 sm:p-20 flex flex-col md:flex-row items-center justify-between gap-12 text-center md:text-left"
          >
            <div className="space-y-4">
