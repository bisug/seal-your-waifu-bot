...
import { BadgeCheck, Lock, CheckCircle2, Trophy, Loader2, Target, ShieldCheck, Activity } from 'lucide-react';
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <Card variant="surface" className="p-4 flex flex-col justify-between">
                        <div className="flex items-center justify-between mb-4">
                            ...
                            <span className="text-[10px] font-mono font-bold text-zinc-400 tabular-nums">{unlockedCount} / {totalCount}</span>
                        </div>
                        <div className="text-2xl font-mono font-bold text-zinc-100 leading-none mb-4">{progressPercent}%</div>
                    ...
                    <Card variant="default" className="p-4 flex flex-col justify-between">
                        <div className="flex items-center justify-between mb-4">
                            <span className="text-[9px] font-bold text-zinc-600 uppercase tracking-widest">Clearance</span>
                        ...
                        <div className="flex items-center gap-3">
                            ...
                            <div className="flex flex-col">
                               <span className="text-[10px] font-bold text-zinc-100 uppercase tracking-wider">PROTO_v2.4</span>
                               <span className="text-[8px] font-bold text-emerald-500 uppercase tracking-widest">AUTHORIZED ACCESS</span>
                            </div>
                        </div>
                    </Card>
                </div>
            ...
            <div className="space-y-3">
                <AnimatePresence mode="popLayout">
                    {sortedAchievements.map((ach) => (
                        <motion.div layout key={ach.id} initial={{ opacity: 0, y: 8 }} animate={{ opacity: 1, y: 0 }}>
                            <Card
                                variant="default"
                                className={cn(
