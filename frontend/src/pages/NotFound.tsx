...
import { Home, ShieldAlert, Sparkles, ArrowLeft } from 'lucide-react';
    ...
    <div className="min-h-[80svh] flex flex-col items-center justify-center p-8 text-center select-none relative overflow-hidden">
      ...
      >
        ...
        <div className="space-y-2 mb-10">
            ...
            <p className="text-[10px] font-bold text-red-500 uppercase tracking-widest">Protocol Error: Page Not Found</p>
      ...
      <div className="absolute bottom-10 left-1/2 -translate-x-1/2 flex items-center gap-2 opacity-20">
         ...
         <span className="text-[7px] font-bold uppercase tracking-widest text-zinc-100">Anomaly Detected</span>
      </div>
    </div>
  );
};
