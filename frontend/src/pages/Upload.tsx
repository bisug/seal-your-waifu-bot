...
export const Upload = () => {
  ...
  const handleSubmit = async (event: FormEvent<HTMLFormElement>) => {
    ...
    try {
      const mediaPayload = source === 'url'
        ? { media_url: mediaUrl.trim() }
        : { media_data: mediaData, filename };
    ...
    <div className="pb-32 pt-6 max-w-3xl mx-auto adaptive-px space-y-8 select-none">
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        <section className="space-y-4">
          <h2 className="text-[10px] font-bold text-zinc-600 uppercase tracking-widest px-1">Media</h2>
          <Card variant="surface" className="p-5 space-y-5">
            <div className="grid grid-cols-2 gap-1 p-1 bg-zinc-950 rounded-md border border-white/5">
                ...
                { id: 'url' as const, label: 'URL', icon: LinkIcon },
                    ...
                    className={cn(
                        ...
                        source === item.id ? 'bg-zinc-800 text-zinc-100' : 'text-zinc-600 hover:text-zinc-400'
                    )}
                    >
                    <item.icon size={12} />
                    {item.label}
            ...
            <AnimatePresence>
                {previewSrc && (
                    <motion.div initial={{ opacity: 0, scale: 0.98 }} animate={{ opacity: 1, scale: 1 }} className="rounded-md overflow-hidden border border-white/5 bg-zinc-950">
        ...
        <section className="space-y-4">
          <h2 className="text-[10px] font-bold text-zinc-600 uppercase tracking-widest px-1">Asset Metadata</h2>
          <Card variant="surface" className="p-5 space-y-6">
            {mode === 'character' ? (
                <div className="space-y-4">
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <div className="space-y-1.5">
                           <span className="text-[9px] font-bold text-zinc-600 uppercase tracking-widest pl-1">Name</span>
                           <Input
                        ...
                        <div className="space-y-1.5">
                           <span className="text-[9px] font-bold text-zinc-600 uppercase tracking-widest pl-1">Source</span>
                           <Input
                    ...
                    <div className="space-y-1.5">
                        ...
                        <div className="relative group">
                            ...
                            <ChevronRight size={14} className="absolute right-3.5 top-1/2 -translate-y-1/2 text-zinc-600 pointer-events-none" />
                        </div>
                    </div>
                </div>
            ) : (
                <div className="space-y-4">
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        ...
                        <div className="space-y-1.5">
                           <span className="text-[9px] font-bold text-zinc-600 uppercase tracking-widest pl-1">ID</span>
                           <Input
                             value={pet.petid}
                    ...
                    <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
                        {[
                            ...
                            <div key={stat.key} className="space-y-1.5">
                                <span className="text-[9px] font-bold text-zinc-700 uppercase tracking-widest pl-1">{stat.label}</span>
                                <Input
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <div className="space-y-1.5">
                           <span className="text-[9px] font-bold text-zinc-600 uppercase tracking-widest pl-1">Class</span>
                           <Input
                             value={pet.rarity}
                        ...
                        <div className="space-y-1.5">
                           <span className="text-[9px] font-bold text-zinc-600 uppercase tracking-widest pl-1">Ability</span>
                           <Input
                             value={pet.ability}
                    ...
                    <div className="space-y-1.5">
                        <span className="text-[9px] font-bold text-zinc-600 uppercase tracking-widest pl-1">Description</span>
                        <textarea
                            value={pet.desc}
                    ...
                    <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 items-end">
                        {[
                            ...
                            <div key={item.key} className="space-y-1.5">
                                <span className="text-[9px] font-bold text-zinc-700 uppercase tracking-widest pl-1">{item.label}</span>
                                <Input
                        ...
                        <div className="flex items-center gap-3 h-10 pl-2">
                            ...
                            id="pet-enabled"
                            />
                            <label htmlFor="pet-enabled" className="text-[9px] font-bold text-zinc-600 uppercase tracking-widest cursor-pointer select-none">
                                Enabled
                            </label>
                        </div>
                    </div>
