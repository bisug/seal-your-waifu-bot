    ...
    <div className="fixed inset-0 bg-[#040908] flex flex-col items-center justify-center p-8 overflow-hidden z-[999] selection:bg-transparent">
      ...
      <div className="relative z-10 flex flex-col items-center">
        <div className="relative w-48 h-48 mb-16 flex items-center justify-center">
          ...
          <div className="absolute inset-4 rounded-full border border-brand-accent/10 animate-pulse-ring" style={{ animationDelay: '1s' }} />
          <div className="absolute inset-8 rounded-[2rem] bg-brand-midnight/40 backdrop-blur-3xl border border-white/10 shadow-lg flex items-center justify-center overflow-hidden">
            <div className="absolute inset-0 bg-gradient-to-tr from-brand-accent/10 via-transparent to-transparent opacity-50" />
            <motion.div
              animate={{ 
                scale: [1, 1.15, 1],
                filter: ["drop-shadow(0 0 0px #3b82f600)", "drop-shadow(0 0 15px #3b82f666)", "drop-shadow(0 0 0px #3b82f600)"]
              }}
              transition={{ duration: 3, repeat: Infinity, ease: "easeInOut" }}
            >
              <Cpu className="text-brand-accent" size={44} strokeWidth={1.5} />
            </motion.div>
          </div>
        ...
        <div className="text-center">
          ...
          >
            <div className="space-y-1">
              <h1 className="text-2xl font-black text-white uppercase tracking-[0.4em] leading-none">Seal<span className="text-brand-accent">Bot</span></h1>
            ...
            <div className="flex flex-col items-center space-y-3">
              <div className="relative w-40 h-[2px] bg-white/5 rounded-full overflow-hidden">
                <motion.div 
                  className="absolute inset-y-0 left-0 bg-brand-accent shadow-[0_0_10px_#3b82f6]"
      ...
      <div className="absolute bottom-12 inset-x-0 flex flex-col items-center opacity-20 hover:opacity-100 transition-opacity duration-700 cursor-default">
        <Sparkles size={12} className="text-brand-accent mb-2" />
