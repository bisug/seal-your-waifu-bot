                    ...
                    <div className="w-full h-full rounded-2xl border border-white/20 bg-zinc-950 shadow-2xl overflow-hidden relative">
                        ...
                        <div className="absolute bottom-0 inset-x-0 p-8 flex flex-col items-center text-center space-y-6">
                            <div className="space-y-3">
                                <Badge variant="primary" className="px-6 h-7 text-[10px] font-bold tracking-widest bg-brand-accent text-white border-none uppercase">
                                    {rarityLabel}
                                </Badge>
                                ...
                                <div className="space-y-1">
                                    ...
                                    <div className="flex items-center justify-center gap-2 opacity-50">
                                       ...
                                       <p className="text-[10px] font-bold text-white uppercase tracking-widest">{character.anime}</p>
                                    </div>
                                </div>
                            </div>
