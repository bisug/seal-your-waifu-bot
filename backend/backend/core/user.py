...
async def get_active_pet(user_id: int) -> dict:
    ...
    from backend.core.pets import ensure_user_pet_state, find_pet, normalize_pet
...
async def add_pet_xp(user_id: int, pet_ref: str, xp_amount: int):
    ...
    from backend.core.pets import ensure_user_pet_state, find_pet_index, get_pet_key, normalize_pet
