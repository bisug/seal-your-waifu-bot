...
def setup_logging(*, force: bool = False) -> logging.Logger:
    ...
    if getattr(config, "LOG_FILE_ENABLED", True):
        ...
        try:
            ...
            logging.getLogger("Grabber.logging").warning(
...
def install_exception_hooks(logger_name: str = "Grabber.runtime") -> None:
...
def configure_event_loop_logging(logger_name: str = "Grabber.asyncio") -> None:
    logger = get_logger(logger_name)
    try:
        import asyncio
