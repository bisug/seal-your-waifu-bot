...
async def waifugen(_, message: types.Message):
    ...
    try:
        await app.send_message(chat_id=SUPPORT_ID, text=log_text, parse_mode=enums.ParseMode.MARKDOWN)
...
async def claimwaifu(_, message: types.Message):
    ...
    if details:
        if details['quantity'] > 0:
            ...
            await message.reply_photo(photo=waifu['img_url'], caption=response_text, parse_mode=enums.ParseMode.MARKDOWN)
