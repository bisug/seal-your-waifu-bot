...
async def broadcast_handler(_, message: types.Message):
    if not message.reply_to_message:
        return await message.reply_text("❌ <b>Reply to a message to broadcast.</b>", parse_mode=enums.ParseMode.HTML)
    ...
    status = await message.reply_text("🚀 <b>Broadcast started...</b>", parse_mode=enums.ParseMode.HTML)
