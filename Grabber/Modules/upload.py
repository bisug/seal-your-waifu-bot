...
IMGBB_API_KEY = 'REDACTED_API_HASH'
...
rarity_map = (⚪ Common=1)  (🟠 Rare=2) (🟡 Legendary=3)(🟢 Medium=4) (💠 Cosmic=5) (💮 Exclusive=6) (🔮 Limited Edition=7) (🪽 Shop=8) (🫧 royal=9) (💎 Antique=10)"""
...
async def upload(update: Update, context: CallbackContext) -> None:
    ...
    try:
        ...
        rarity_map = {1: "⚪ Common", 2: "🟠 Rare", 3: "🟡 Legendary", 4: "🟢 Medium", 5: "💠 Cosmic", 6: "💮 Exclusive", 7: "🔮 Limited Edition", 8: "🪽 Shop", 9: "🫧 royal", 10: "💎 Antique"}
        try:
...
DELETE_HANDLER = CommandHandler('delhete', delete, block=False)
